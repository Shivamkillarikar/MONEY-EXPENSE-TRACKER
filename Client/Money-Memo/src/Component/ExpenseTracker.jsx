...
const ExpenseTracker = ({ expenses, setExpenses }) => {
    ...
    const handleAddExpense = async (event) => {
        ...
        // Assuming you have input fields for expense details
        const expenseName = event.target.expenseName.value; // or however you're getting it
        const expenseAmount = event.target.expenseAmount.value; // example for amount
    ...
    const handleViewCharts = () => {
        navigate('/tracker/charts'); // Redirect to the charts page
    };
    ...
    return (
        <div>
            ...
            <button onClick={handleViewCharts}>View Charts</button> {/* Button to view charts */}
